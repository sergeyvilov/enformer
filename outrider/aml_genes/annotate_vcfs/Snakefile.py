...
progress_dir = '/lustre/groups/epigenereg01/workspace/projects/vale/outrider/outrider_210223/' #output dir

input_data_dir='/lustre/groups/epigenereg01/projects/vale/data/202011061/MLL_vcfs/'
...
all_patients=pd.read_csv(outrider_results)['VCF_file'].str.replace('.vcf.gz','').unique()
