...
promoter_length=sys.argv[1]
promoter_dir=sys.argv[2]
max_gnomAD_AF=sys.argv[3]
...
enformer_model_dir = '/lustre/groups/epigenereg01/workspace/projects/vale/tools/enformer/model/'
fasta_fa = '/lustre/groups/epigenereg01/workspace/projects/vale/outrider/gene_coords/insignificant_genes_GRCh37.fa'
tss_tsv = '/lustre/groups/epigenereg01/workspace/projects/vale/outrider/gene_coords/transcripts_canonocal_GRCh37.bed'


# In[18]:


variants_tsv=f"/lustre/groups/epigenereg01/workspace/projects/vale/outrider/promoter_variants/insignificant_genes/max_gnomAD_{max_gnomAD_AF}/promoters_{promoter_length}_{promoter_dir}.tsv"
output_dir = f'/lustre/groups/epigenereg01/workspace/projects/vale/outrider/outrider_210223/insignificant_genes/max_gnomAD_{max_gnomAD_AF}/promoters_{promoter_length}_{promoter_dir}/'
